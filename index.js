...
const appSettings = {
    databaseURL: "https://realtime-database-947ef-default-rtdb.firebaseio.com/"
}

const app = initializeApp(appSettings)
const database = getDatabase(app)
const shoppingListInDB = ref(database, "mess")
...
function appendlist(item) {
    ...
    newEl.addEventListener("click", function() {
        let exactLocationOfItemInDB = ref(database,`mess/${itemID}` )
